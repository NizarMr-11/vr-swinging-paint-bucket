...
namespace SwingingPaintBucket.Interface.UI
{
    public class SettingsPanel : MonoBehaviour
    {
        ...
        private CanvasOverlayBinder _canvasOverlayBinder;
        ...
        private void BuildBucketSection(Transform parent)
        {
            ...
            _bucketWeightSlider = CreateHorizontalSlider(
                parent,
                "Bucket Weight",
                0.1f,
                50f,
                _bucket != null ? _bucket.BucketWeightKg : 1f,
                "kg"
            );

            _bucketRadiusSlider = CreateHorizontalSlider(
                parent,
                "Bucket Radius",
                0.03f,
                0.5f,
                _bucket != null ? _bucket.BucketRadius : 0.15f,
                "m"
            );
        ...
        private void BuildRopePendulumSection(Transform parent)
        {
            ...
            _ropeLengthSlider = CreateHorizontalSlider(
                parent,
                "Rope Length",
                0.5f,
                20f,
                _pendulum != null ? _pendulum.RopeLength : 5f,
                "m"
            );

            CreateCycleSelector(parent, "Rope Type", CycleRopeType, out _ropeTypeText);

            _gravitySlider = CreateHorizontalSlider(
                parent,
                "Gravity",
                0f,
                20f,
                _pendulum != null ? _pendulum.Gravity : 9.81f,
                "m/s²"
            );

            _airResistanceSlider = CreateHorizontalSlider(
                parent,
                "Air Resistance",
                0f,
                1f,
                _pendulum != null ? _pendulum.AirResistanceCoefficient : 0.05f,
                ""
            );

            _frictionSlider = CreateHorizontalSlider(
                parent,
                "Friction",
                0f,
                1f,
                _pendulum != null ? _pendulum.FrictionCoefficient : 0.02f,
                ""
            );

            _initialAngleSlider = CreateHorizontalSlider(
                parent,
                "Initial Angle",
                -180f,
                180f,
                _pendulum != null ? _pendulum.InitialAngleDegrees : 45f,
                "°"
            );

            _initialPhiSlider = CreateHorizontalSlider(
                parent,
                "Launch Direction Angle",
                -180f,
                180f,
                _pendulum != null ? _pendulum.InitialPhiDegrees : 0f,
                "°"
            );

            CreateCycleSelector(parent, "Direction of Movement", CycleDirection, out _directionText);

            _angularVelocitySlider = CreateHorizontalSlider(
                parent,
                "Initial Angular Speed",
                0f,
                10f,
                _pendulum != null ? _pendulum.InitialAngularVelocity : 0f,
                "rad/s"
            );

            _swingCountSlider = CreateHorizontalSlider(
                parent,
                "Number of Swings",
                0f,
                50f,
                _pendulum != null ? _pendulum.TargetSwingCount : 0f,
                ""
            );
        ...
        private void BuildPaintSection(Transform parent)
        {
            ...
            _paintVolumeSlider = CreateHorizontalSlider(
                parent,
                "Paint Volume",
                0.1f,
                10f,
                _bucket != null ? _bucket.InitialPaintVolume : 2f,
                "L"
            );

            _viscositySlider = CreateHorizontalSlider(
                parent,
                "Viscosity",
                0.1f,
                10f,
                _bucket != null ? _bucket.Viscosity : 1f,
                ""
            );

            _densitySlider = CreateHorizontalSlider(
                parent,
                "Density",
                0.1f,
                5f,
                _bucket != null ? _bucket.Density : 1f,
                "g/cm³"
            );

            _nozzleRadiusSlider = CreateHorizontalSlider(
                parent,
                "Nozzle Radius",
                0.001f,
                0.05f,
                _bucket != null ? _bucket.NozzleRadius : 0.005f,
                "m"
            );

            _dischargeSlider = CreateHorizontalSlider(
                parent,
                "Discharge Coeff.",
                0.1f,
                1f,
                _bucket != null ? _bucket.DischargeCoefficent : 0.7f,
                ""
            );

            _paintLossSlider = CreateHorizontalSlider(
                parent,
                "Bucket Paint Loss",
                0f,
                0.5f,
                _bucket != null ? _bucket.PaintLossRate : 0.02f,
                "L/s"
            );

            _absorptionSlider = CreateHorizontalSlider(
                parent,
                "Bucket Absorption",
                0f,
                0.1f,
                _bucket != null ? _bucket.AbsorptionRate : 0f,
                "L/s"
            );
        ...
        private void BuildEnvironmentSection(Transform parent)
        {
            ...
            _temperatureSlider = CreateHorizontalSlider(
                parent,
                "Temperature",
                0f,
                50f,
                _environment != null ? _environment.Temperature : 20f,
                "°C"
            );

            _humiditySlider = CreateHorizontalSlider(
                parent,
                "Humidity",
                0f,
                100f,
                _environment != null ? _environment.Humidity : 50f,
                "%"
            );
        ...
        private void BuildCanvasSection(Transform parent)
        {
            ...
            _canvasWidthSlider = CreateHorizontalSlider(
                parent,
                "Canvas Width",
                0.5f,
                15f,
                _canvas != null ? _canvas.CanvasWidthMeters : 10f,
                "m"
            );

            _canvasHeightSlider = CreateHorizontalSlider(
                parent,
                "Canvas Height",
                0.5f,
                15f,
                _canvas != null ? _canvas.CanvasHeightMeters : 6f,
                "m"
            );

            _canvasTiltSlider = CreateHorizontalSlider(
                parent,
                "Canvas Tilt",
                -60f,
                60f,
                _canvas != null ? _canvas.CanvasTiltDegrees : 0f,
                "°"
            );

            _canvasImpactSlider = CreateHorizontalSlider(
                parent,
                "Particle Impact Size",
                0.1f,
                5f,
                _canvas != null ? _canvas.ParticleImpactSize : 1f,
                ""
            );
        ...
        private void BuildAppearanceSection(Transform parent)
        {
            ...
            _paintColorText = CreateSmallText(
                row.transform,
                "Red",
                AccentColor,
        ...
        public void ApplySettings()
        {
            ...
            if (_pendulum != null)
            {
                ...
                _pendulum.DirectionOfMovement = _directionIndex == 0
            ...
            CanvasSurfaceType selectedSurface = (CanvasSurfaceType)_canvasSurfaceIndex;

            if (_canvasOverlayBinder != null)
            {
                _canvasOverlayBinder.SetSurfaceType(selectedSurface);
            }

            if (_canvas != null)
            {
                _canvas.SurfaceType = selectedSurface;
            ...
            Debug.Log("[SettingsPanel] Settings applied and simulation restarted.");
        }

        private void LoadSavedValues()
        {
            if (_bucketWeightSlider != null)
                _bucketWeightSlider.value = PlayerPrefs.GetFloat("Sim_BucketWeight", _bucket != null ? _bucket.BucketWeightKg : 1f);

            if (_bucketRadiusSlider != null)
                _bucketRadiusSlider.value = PlayerPrefs.GetFloat("Sim_BucketRadius", _bucket != null ? _bucket.BucketRadius : 0.15f);

            if (_ropeLengthSlider != null)
                _ropeLengthSlider.value = PlayerPrefs.GetFloat("Sim_RopeLength", _pendulum != null ? _pendulum.RopeLength : 5f);

            if (_gravitySlider != null)
                _gravitySlider.value = PlayerPrefs.GetFloat("Sim_Gravity", _pendulum != null ? _pendulum.Gravity : 9.81f);

            if (_airResistanceSlider != null)
                _airResistanceSlider.value = PlayerPrefs.GetFloat("Sim_AirResistance", _pendulum != null ? _pendulum.AirResistanceCoefficient : 0.05f);

            if (_frictionSlider != null)
                _frictionSlider.value = PlayerPrefs.GetFloat("Sim_Friction", _pendulum != null ? _pendulum.FrictionCoefficient : 0.02f);

            if (_initialAngleSlider != null)
                _initialAngleSlider.value = PlayerPrefs.GetFloat("Sim_InitialAngle", _pendulum != null ? _pendulum.InitialAngleDegrees : 45f);

            if (_initialPhiSlider != null)
                _initialPhiSlider.value = PlayerPrefs.GetFloat("Sim_InitialPhi", _pendulum != null ? _pendulum.InitialPhiDegrees : 0f);

            if (_angularVelocitySlider != null)
                _angularVelocitySlider.value = PlayerPrefs.GetFloat("Sim_AngularVelocity", _pendulum != null ? _pendulum.InitialAngularVelocity : 0f);

            if (_swingCountSlider != null)
                _swingCountSlider.value = PlayerPrefs.GetInt("Sim_TargetSwings", _pendulum != null ? _pendulum.TargetSwingCount : 0);

            if (_paintVolumeSlider != null)
                _paintVolumeSlider.value = PlayerPrefs.GetFloat("Sim_PaintVolume", _bucket != null ? _bucket.InitialPaintVolume : 2f);

            if (_viscositySlider != null)
                _viscositySlider.value = PlayerPrefs.GetFloat("Sim_Viscosity", _bucket != null ? _bucket.Viscosity : 1f);

            if (_densitySlider != null)
                _densitySlider.value = PlayerPrefs.GetFloat("Sim_Density", _bucket != null ? _bucket.Density : 1f);

            if (_nozzleRadiusSlider != null)
                _nozzleRadiusSlider.value = PlayerPrefs.GetFloat("Sim_NozzleRadius", _bucket != null ? _bucket.NozzleRadius : 0.005f);

            if (_dischargeSlider != null)
                _dischargeSlider.value = PlayerPrefs.GetFloat("Sim_Discharge", _bucket != null ? _bucket.DischargeCoefficent : 0.7f);

            if (_paintLossSlider != null)
                _paintLossSlider.value = PlayerPrefs.GetFloat("Sim_PaintLoss", _bucket != null ? _bucket.PaintLossRate : 0.02f);

            if (_absorptionSlider != null)
                _absorptionSlider.value = PlayerPrefs.GetFloat("Sim_Absorption", _bucket != null ? _bucket.AbsorptionRate : 0f);

            if (_temperatureSlider != null)
                _temperatureSlider.value = PlayerPrefs.GetFloat("Sim_Temperature", _environment != null ? _environment.Temperature : 20f);

            if (_humiditySlider != null)
                _humiditySlider.value = PlayerPrefs.GetFloat("Sim_Humidity", _environment != null ? _environment.Humidity : 50f);

            if (_canvasWidthSlider != null)
                _canvasWidthSlider.value = PlayerPrefs.GetFloat("Sim_CanvasWidth", _canvas != null ? _canvas.CanvasWidthMeters : 10f);

            if (_canvasHeightSlider != null)
                _canvasHeightSlider.value = PlayerPrefs.GetFloat("Sim_CanvasHeight", _canvas != null ? _canvas.CanvasHeightMeters : 6f);

            if (_canvasTiltSlider != null)
                _canvasTiltSlider.value = PlayerPrefs.GetFloat("Sim_CanvasTilt", _canvas != null ? _canvas.CanvasTiltDegrees : 0f);

            if (_canvasImpactSlider != null)
                _canvasImpactSlider.value = PlayerPrefs.GetFloat("Sim_CanvasImpact", _canvas != null ? _canvas.ParticleImpactSize : 1f);
        ...
        private void CacheReferences()
        {
            ...
            _canvasOverlayBinder = FindAnyObjectByType<CanvasOverlayBinder>();
        ...
        private Slider CreateHorizontalSlider(Transform parent, string label, float min, float max, float current, string unit)
        {
            ...
            var valueText = CreateSmallText(
                sliderArea.transform,
                FormatValue(current, max, unit),
                AccentColor,
        ...
        private GameObject CreateSmallText(
            Transform parent,
            string text,
            Color color,
