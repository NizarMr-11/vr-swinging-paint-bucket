...
{
    /// <summary>Layer color row: preview stripe, preset chips, and custom HSV picker.</summary>
    public sealed class V4Lab2LayerColorPicker : MonoBehaviour
    {
        ...
        private V4Lab2HsvColorPickerPanel _customPicker;
        ...
        private void EnsureCustomPicker()
        {
            ...
            _customPicker = V4Lab2HsvColorPickerPanel.Attach(transform, preview, color =>
            {
