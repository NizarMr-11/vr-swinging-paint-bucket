...
namespace HarmonicEngine.Infrastructure.Management
{
    ...
    public interface IHarmonicParticleSource
    {
        ...
        /// <summary>Internal/container SPH particle SOA buffers + count for this frame.</summary>
        bool TryGetInternalParticleSoa(out ParticleSoaBuffers soa, out uint count);

        /// <summary>World-space falling particle SOA buffers + count for this frame.</summary>
        bool TryGetFallingParticleSoa(out ParticleSoaBuffers soa, out uint count);
    }
