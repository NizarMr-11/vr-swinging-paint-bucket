...
namespace HarmonicEngine.Infrastructure.Management
{
    public partial class HarmonicPipelineController
    {
        ...
        internal ParticleSoaBuffers SoaFalling => _soaFalling;
        internal ParticleSoaBuffers SoaFallingWorld => _soaFallingWorld;
        ...
        internal int KernelPbfAppendSpilled => _kernelPbfAppendSpilled;
        ...
        internal void SwapFallingParticleBuffers() => _gpuPool.SwapFallingParticleBuffers();
        ...
        internal void PassBindFallingAppendSoa(ComputeShader shader, int kernel, ParticleSoaBuffers soa) =>
            BindFallingAppendSoa(shader, kernel, soa);
